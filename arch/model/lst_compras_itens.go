...
type LstCompras_Itens struct {
	...
	Preco            int        `json:"preco" db:"lst_compras_itens_preco"`
...
type LstCompras_Itens_Update struct {
	...
	Preco      int `json:"preco" db:"lst_compras_itens_preco" validate:"required"`
}
...
type LstCompras_Itens_Filters struct {
	...
	Product_Name  string `query:"products_name:ILIKE:a"`
}
